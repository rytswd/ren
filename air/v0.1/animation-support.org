...
// Content effects
pub fn fadeIn(writer, allocator, block, FadeConfig) !void
pub fn typewriter(writer, block, FrameInfo, TypewriterConfig) !void

// Frame effects
pub fn glow(writer, allocator, block, FrameInfo, GlowConfig) !void

// Combined (frame effect + content effect)
pub fn glowThenFade(writer, allocator, block, FrameInfo, GlowConfig, FadeConfig) !void
...
try ren.render.fadeIn(&writer, allocator, block, .{});  // fade-in
// or
try ren.render.typewriter(&writer, block, .box, .{});   // typewriter
// or
try ren.render.glow(&writer, allocator, block, .box, .{});  // border glow
#+end_src

** Combined: Glow Then Fade
#+begin_src zig
// Border glows first, then content fades in
try ren.render.glowThenFade(&writer, allocator, block, .box,
...
try ren.render.fadeIn(&writer, allocator, header_block, .{});
